...
punctuation = ".,!?;:"  # Znaky interpunkce k odstranění
...
uppercase_word = [word for word in text_cleaned if word.isupper()]
lowercase_word = [word for word in text_cleaned if word.islower()]
numbers_as_word = [int(word) for word in text_cleaned if word.isnumeric()]

print("\nThe total number of words in the text is:", len(text_split))
...
# Graf
print("\nA bar chart for the frequency of different word lengths in the text:")
word_lengths = {}
